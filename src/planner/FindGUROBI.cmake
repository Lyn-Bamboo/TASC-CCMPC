...
if (NOT GUROBI_FOUND)
    ...
    find_library( GUROBI_C_LIBRARY
                  NAMES gurobi gurobi110 libgurobi
    ...
    # message("GUROBI_INCLUDE_DIRS 的值为: ${GUROBI_INCLUDE_DIRS}")
    # message("GUROBI_LIBRARIES 的值为: ${GUROBI_LIBRARIES}")
    # message("GUROBI_C_LIBRARY 的值为: ${GUROBI_C_LIBRARY}")
